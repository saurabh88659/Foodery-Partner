...
function SelectedTempProductsMain({navigation, route}) {
  ...
  return (
    <SafeAreaView key={refreshKey} style={styles.container}>
      ...
      <SelectedTempProductsScreenComponent onPress={handleSelectedItemSubmit} />
    </SafeAreaView>
  );
}
...
export default SelectedTempProductsMain;
